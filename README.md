...
- **Spec Ready**: Class Attendance, Modify User Schedule.
- **Pending**: Initial Schedule Assignment, Class Attendance (Implementation), Modify User Schedule (Implementation).
